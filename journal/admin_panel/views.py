...
from profiles.models import Functional, Anthropometric
...
class AdminPanelView(TemplateView, View):
    ...
    profile_controllers = ProfileControllers(anthropometric_table_controllers, functional_table_controllers)
